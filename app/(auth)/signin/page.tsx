    ...
    return (
        <div className="mt-24 rounded-lg bg-black/65 py-10 px-36 md:mt-0 max-w-lg md:px-14 flex flex-col justify-center items-center debug-screens z-50">
            <form>
                <div className="flex flex-col justify-center items-center">
                    <h1 className="text-3xl font-bold text-white flex justify-center items-center">
                        <Cross className="mr-3" />BIEN-AIME INSCRIS TOI
                    </h1>
                </div>
                <div className="space-y-4 mt-5 w-full">
                    <Button onClick={() => router.push("/bntvid/signin")} type="button" className="w-[400px] bg-neutral-900 text-white font-bold hover:bg-blue-700 py-7 border border-spacing-1 border-gray-600">
                        <a href="/./bntvid/signin">BNTV ID</a>
                    </Button>
                </div>
            </form>
            <div className="flex flex-col justify-center items-center">
                <hr />
                <p className="text-2xs font-medium text-white text-center mt-3 mb-3"> OU </p>
            ...
            <div className="flex gap-x-3 text-zinc-300 font-medium text-2xs mt-3">
                Avez-vous déjà un compte ? <a href="/login" className="text-white font-bold mr-3 hover:underline">connectez vous</a>
            </div>
        </div>
    );
}
